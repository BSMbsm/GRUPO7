...
Con la evolucion de la tecnologia y el incremento de dispositivos moviles el internet se ha convertido en una necesidad del dia a dia, diferentes dispositivos proveen una conexion a los usuarios de diferentes maneras y en distintas aplicaciones, para esto los operadores moviles deben estar al pendiente de la utilizacion de la red movil y los servicios de internet. 
Bolivia es uno de los paises con un ranking muy bajo en la region de Sudamerica, con respecto a las velocidades de internet provistas a los usuarios, en 2020 Bolivia presento un proyecto de una salida soberana e internacional de conexion directa hacia los proveedores de Internet, teniendo asi mayor capacidad de la conexion internacional. Entonces por que Bolivia aun sigue entre los paises con menores valores de velocidades de Internet?.
En este trabajo se realiza el analisis de los resultados obtenidos por Okkla mediante la aplicacion Speedtest a traves del dataset provisto con las mediciones realizadas mediante las redes moviles de internet en todo el pais.

Del analisis realizado para todas las mediciones de velocidades de internet obtenidas del dataset de Okkla, se observa que durante este año se incremento los valores de latencia y ping, asi mismo existe proveedores que tienen velocidades bajas, las cuales afectan directamente en el promedio y los datos para obtener un resultado general, dando una conclusion de que los operadores deben mejorar estos valores a traves de mejora en sus radiobases con mayor y mejor tecnologia movil, realizando ampliaciones de cobertura, capacidad y otros recurso que ayudaran a mejorar la experiencia de los usuarios. 
...
Procedemos a importar del archivo csv de Google Sheets, se subió el dataset a la nube para su fácil acceso.
...
Con los valores calculados del promedio y desviación estandar, generamos la normal de cada variable.
...
**Grafico de las coordenadas geograficas de las pruebas**

Se realizara el grafico de las coordenadas geograficas del puntos donde se realizo las pruebas en Bolivia.
